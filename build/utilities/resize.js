...
router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var name, width, heigh, output;
    return __generator(this, function (_a) {
        name = ('images/' + req.query.name);
        width = parseInt(req.query.width);
        heigh = parseInt(req.query.heigh);
        output = path_1.default.dirname(path_1.default.dirname(__dirname)) + '/output/' + width + '-' + heigh + '-' + req.query.name;
        if (serve_1.default.queryValid(width, heigh, name)) {
            console.log('valid query');
            if (serve_1.default.cashing(output)) {
                console.log('cached');
                return [2 /*return*/, res.sendFile(output)];
            }
            else {
                serve_1.default.image_process(req, res, output);
            }
        }
        else {
